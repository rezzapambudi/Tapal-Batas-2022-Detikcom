...
function heightMenu(){
  ...
  if ($('#a').hasClass('menu-sidebar') && ($body.width() + scrollWidth) > 767) {
    var firstBoxHeight = $('#a.menu-sidebar .first').height();
    var thirdBoxHeight = $('#a.menu-sidebar .third').height();

    $("#a.menu-sidebar .menu-box").css("height", (maxHeight - firstBoxHeight - thirdBoxHeight) );
  };
}
